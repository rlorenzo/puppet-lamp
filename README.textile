...
** Then create a file called 'config_private.php' in the ~/Projects/moodle20/moodle directory with the database password and other details that Moodle prompted you to create for the configuration file. Be sure to remove the lines:
unset($CFG);
global $CFG;
$CFG = new stdClass();
