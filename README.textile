...
*** ln -s local/ucla/config/shared_dev_moodle-config.php
** Then create a file called 'config_private.php' in the ~/Projects/moodle20/moodle directory with the database password and other details that Moodle prompted you to create for the configuration file. But be sure to remove the lines:
bc. unset($CFG);
global $CFG;
$CFG = new stdClass();
